use super::configs::xcm_config;
use super::{
	build_state, fee, genesis_config_presets, get_preset, AccountId, ApplyExtrinsicResult, AssetId,
	AuraId, Balance, Block, CallDryRunEffects, CollatorStaking, ConsensusHook, Dmarket, Executive,
	ExtrinsicInclusionMode, Hash, InherentDataExt, Item, KeyTypeId, Moment, Nonce, OpaqueMetadata,
	OriginCaller, ParachainSystem, PolkadotXcm, Runtime, RuntimeCall, RuntimeEvent,
	RuntimeGenesisConfig, RuntimeVersion, SessionKeys, System, TradeParams, TransactionPayment,
	TransactionSource, TransactionValidity, VersionedAssets, XcmDryRunApiError, XcmDryRunEffects,
	XcmPaymentApiError, XcmVersion, SLOT_DURATION, VERSION,
};
use alloc::vec;
use alloc::vec::Vec;
use frame_support::weights::Weight;
use sp_runtime::traits::Block as BlockT;
use xcm::{VersionedAssetId, VersionedLocation, VersionedXcm};
...
sp_api::impl_runtime_apis! {
	...
	impl xcm_runtime_apis::fees::XcmPaymentApi<Block> for Runtime {
		fn query_acceptable_payment_assets(xcm_version: xcm::Version) -> Result<Vec<VersionedAssetId>, XcmPaymentApiError> {
			// We only handle the native token
