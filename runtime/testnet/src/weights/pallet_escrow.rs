...
impl<T: frame_system::Config> pallet_escrow::WeightInfo for WeightInfo<T> {
	...
	fn deposit() -> Weight {
		...
		Weight::from_parts(136_331_000, 0)
	...
	fn release() -> Weight {
		...
		//  Measured:  `357`
		//  Estimated: `3581`
		// Minimum execution time: 70_081_000 picoseconds.
		Weight::from_parts(71_261_000, 0)
			.saturating_add(Weight::from_parts(0, 3581))
			.saturating_add(T::DbWeight::get().reads(3))
			.saturating_add(T::DbWeight::get().writes(3))
	}
	...
	fn revoke() -> Weight {
		...
		//  Measured:  `357`
		//  Estimated: `3581`
		// Minimum execution time: 121_041_000 picoseconds.
		Weight::from_parts(122_431_000, 0)
			.saturating_add(Weight::from_parts(0, 3581))
			.saturating_add(T::DbWeight::get().reads(3))
			.saturating_add(T::DbWeight::get().writes(3))
	}
