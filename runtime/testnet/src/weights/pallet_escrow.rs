...
impl<T: frame_system::Config> pallet_escrow::WeightInfo for WeightInfo<T> {
	...
	fn deposit() -> Weight {
		...
		//  Measured:  `200`
		//  Estimated: `3581`
		// Minimum execution time: 118_271_000 picoseconds.
		Weight::from_parts(120_582_000, 0)
	...
	fn revoke() -> Weight {
		...
		//  Measured:  `357`
		//  Estimated: `3581`
		// Minimum execution time: 109_501_000 picoseconds.
		Weight::from_parts(110_561_000, 0)
			.saturating_add(Weight::from_parts(0, 3581))
			.saturating_add(T::DbWeight::get().reads(3))
			.saturating_add(T::DbWeight::get().writes(3))
	}
