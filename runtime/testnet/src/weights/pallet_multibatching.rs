...
impl<T: frame_system::Config> pallet_multibatching::WeightInfo for WeightInfo<T> {
	...
	fn batch(c: u32, s: u32, ) -> Weight {
		...
		//  Measured:  `12`
		//  Estimated: `3497`
		// Minimum execution time: 446_995_000 picoseconds.
		Weight::from_parts(455_565_000, 0)
			.saturating_add(Weight::from_parts(0, 3497))
			// Standard Error: 201_585
			.saturating_add(Weight::from_parts(6_100_505, 0).saturating_mul(c.into()))
			// Standard Error: 201_585
			.saturating_add(Weight::from_parts(57_955_745, 0).saturating_mul(s.into()))
