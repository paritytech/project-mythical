...
impl<T: frame_system::Config> pallet_multibatching::WeightInfo for WeightInfo<T> {
	...
	fn batch(c: u32, s: u32, ) -> Weight {
		...
		//  Measured:  `12`
		//  Estimated: `3497`
		// Minimum execution time: 468_301_000 picoseconds.
		Weight::from_parts(473_431_000, 0)
			.saturating_add(Weight::from_parts(0, 3497))
			// Standard Error: 200_989
			.saturating_add(Weight::from_parts(6_116_700, 0).saturating_mul(c.into()))
			// Standard Error: 200_989
			.saturating_add(Weight::from_parts(57_108_282, 0).saturating_mul(s.into()))
	...
	fn batch_v2(c: u32, s: u32, ) -> Weight {
		...
		//  Measured:  `12`
		//  Estimated: `3497`
		// Minimum execution time: 473_598_000 picoseconds.
		Weight::from_parts(475_819_000, 0)
			.saturating_add(Weight::from_parts(0, 3497))
			// Standard Error: 200_700
			.saturating_add(Weight::from_parts(6_057_360, 0).saturating_mul(c.into()))
			// Standard Error: 200_700
			.saturating_add(Weight::from_parts(57_217_453, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(1))
	}
}
