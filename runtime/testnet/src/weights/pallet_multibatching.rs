...
impl<T: frame_system::Config> pallet_multibatching::WeightInfo for WeightInfo<T> {
	...
	fn batch(c: u32, s: u32, ) -> Weight {
		...
		//  Measured:  `84`
		//  Estimated: `3497`
		// Minimum execution time: 370_041_000 picoseconds.
		Weight::from_parts(373_162_000, 0)
			.saturating_add(Weight::from_parts(0, 3497))
			// Standard Error: 209_253
			.saturating_add(Weight::from_parts(6_305_866, 0).saturating_mul(c.into()))
			// Standard Error: 209_253
			.saturating_add(Weight::from_parts(59_750_721, 0).saturating_mul(s.into()))
	...
	fn batch_v2(c: u32, s: u32, ) -> Weight {
		...
		//  Measured:  `84`
		//  Estimated: `3497`
		// Minimum execution time: 371_051_000 picoseconds.
		Weight::from_parts(374_491_000, 0)
			.saturating_add(Weight::from_parts(0, 3497))
			// Standard Error: 207_193
			.saturating_add(Weight::from_parts(6_228_002, 0).saturating_mul(c.into()))
			// Standard Error: 207_193
			.saturating_add(Weight::from_parts(59_895_319, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(1))
	}
}
