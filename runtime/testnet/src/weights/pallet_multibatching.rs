...
impl<T: frame_system::Config> pallet_multibatching::WeightInfo for WeightInfo<T> {
	...
	fn batch(c: u32, s: u32, ) -> Weight {
		...
		//  Measured:  `12`
		//  Estimated: `3497`
		// Minimum execution time: 489_993_000 picoseconds.
		Weight::from_parts(491_713_000, 0)
			.saturating_add(Weight::from_parts(0, 3497))
			// Standard Error: 201_930
			.saturating_add(Weight::from_parts(6_059_155, 0).saturating_mul(c.into()))
			// Standard Error: 201_930
			.saturating_add(Weight::from_parts(57_468_857, 0).saturating_mul(s.into()))
