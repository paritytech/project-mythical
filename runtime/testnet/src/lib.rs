...
use runtime_common::{AccountId, Balance, BlockNumber, Hash, Nonce, Signature, SLOT_DURATION};
...
pub mod fee {
	use super::{Balance, ExtrinsicBaseWeight, MILLI_MUSE, MILLI_PAS};
...
// PAS has 10 decimal places
pub const MICRO_PAS: Balance = 1_000_000;
pub const MILLI_PAS: Balance = 1_000 * MICRO_PAS;
