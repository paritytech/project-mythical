...
impl<T: frame_system::Config> pallet_escrow::WeightInfo for WeightInfo<T> {
	...
	fn deposit() -> Weight {
		...
		//  Measured:  `200`
		//  Estimated: `3581`
		// Minimum execution time: 127_010_000 picoseconds.
		Weight::from_parts(129_410_000, 0)
	...
	fn release() -> Weight {
		...
		//  Measured:  `357`
		//  Estimated: `3581`
		// Minimum execution time: 67_010_000 picoseconds.
	...
	fn revoke() -> Weight {
		...
		Weight::from_parts(116_650_000, 0)
			.saturating_add(Weight::from_parts(0, 3581))
			.saturating_add(T::DbWeight::get().reads(3))
			.saturating_add(T::DbWeight::get().writes(3))
	}
