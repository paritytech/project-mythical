...
impl<T: frame_system::Config> pallet_multibatching::WeightInfo for WeightInfo<T> {
	...
	fn batch(c: u32, s: u32, ) -> Weight {
		...
		//  Measured:  `12`
		//  Estimated: `3497`
		// Minimum execution time: 429_784_000 picoseconds.
		Weight::from_parts(432_944_000, 0)
			.saturating_add(Weight::from_parts(0, 3497))
			// Standard Error: 198_684
			.saturating_add(Weight::from_parts(5_974_389, 0).saturating_mul(c.into()))
			// Standard Error: 198_684
			.saturating_add(Weight::from_parts(57_368_840, 0).saturating_mul(s.into()))
