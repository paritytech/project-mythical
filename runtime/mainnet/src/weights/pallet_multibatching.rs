...
impl<T: frame_system::Config> pallet_multibatching::WeightInfo for WeightInfo<T> {
	...
	fn batch(c: u32, s: u32, ) -> Weight {
		...
		//  Measured:  `12`
		//  Estimated: `3497`
		// Minimum execution time: 493_883_000 picoseconds.
		Weight::from_parts(499_753_000, 0)
			.saturating_add(Weight::from_parts(0, 3497))
			// Standard Error: 207_529
			.saturating_add(Weight::from_parts(6_207_386, 0).saturating_mul(c.into()))
			// Standard Error: 207_529
			.saturating_add(Weight::from_parts(57_397_802, 0).saturating_mul(s.into()))
