...
impl<T: frame_system::Config> pallet_multibatching::WeightInfo for WeightInfo<T> {
	...
	fn batch(c: u32, s: u32, ) -> Weight {
		...
		//  Measured:  `118`
		//  Estimated: `3497`
		// Minimum execution time: 364_801_000 picoseconds.
		Weight::from_parts(367_201_000, 0)
			.saturating_add(Weight::from_parts(0, 3497))
			// Standard Error: 208_966
			.saturating_add(Weight::from_parts(6_237_648, 0).saturating_mul(c.into()))
			// Standard Error: 208_966
			.saturating_add(Weight::from_parts(59_865_048, 0).saturating_mul(s.into()))
	...
	fn batch_v2(c: u32, s: u32, ) -> Weight {
		...
		//  Measured:  `118`
		//  Estimated: `3497`
		// Minimum execution time: 364_940_000 picoseconds.
		Weight::from_parts(366_520_000, 0)
			.saturating_add(Weight::from_parts(0, 3497))
			// Standard Error: 206_420
			.saturating_add(Weight::from_parts(6_279_065, 0).saturating_mul(c.into()))
			// Standard Error: 206_420
			.saturating_add(Weight::from_parts(59_861_736, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(1))
	}
}
