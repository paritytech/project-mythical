...
impl<T: frame_system::Config> pallet_multibatching::WeightInfo for WeightInfo<T> {
	...
	fn batch(c: u32, s: u32, ) -> Weight {
		...
		//  Measured:  `118`
		//  Estimated: `3497`
		// Minimum execution time: 479_023_000 picoseconds.
		Weight::from_parts(482_314_000, 0)
			.saturating_add(Weight::from_parts(0, 3497))
			// Standard Error: 201_041
			.saturating_add(Weight::from_parts(6_064_972, 0).saturating_mul(c.into()))
			// Standard Error: 201_041
			.saturating_add(Weight::from_parts(57_444_694, 0).saturating_mul(s.into()))
	...
	fn batch_v2(c: u32, s: u32, ) -> Weight {
		...
		//  Measured:  `118`
		//  Estimated: `3497`
		// Minimum execution time: 478_983_000 picoseconds.
		Weight::from_parts(484_023_000, 0)
			.saturating_add(Weight::from_parts(0, 3497))
			// Standard Error: 202_281
			.saturating_add(Weight::from_parts(6_090_877, 0).saturating_mul(c.into()))
			// Standard Error: 202_281
			.saturating_add(Weight::from_parts(57_478_333, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(1))
	}
}
