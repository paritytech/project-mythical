...
impl<T: frame_system::Config> pallet_multibatching::WeightInfo for WeightInfo<T> {
	...
	fn batch(c: u32, s: u32, ) -> Weight {
		...
		//  Measured:  `12`
		//  Estimated: `3497`
		// Minimum execution time: 488_143_000 picoseconds.
		Weight::from_parts(497_863_000, 0)
			.saturating_add(Weight::from_parts(0, 3497))
			// Standard Error: 200_979
			.saturating_add(Weight::from_parts(5_989_676, 0).saturating_mul(c.into()))
			// Standard Error: 200_979
			.saturating_add(Weight::from_parts(57_523_530, 0).saturating_mul(s.into()))
