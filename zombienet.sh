...
POLKADOT_V="polkadot-stable2503"
...
fetch_polkadot() {
  ...
  pushd "$BIN_DIR"
    wget -O polkadot "https://github.com/paritytech/polkadot-sdk/releases/download/$POLKADOT_V/polkadot$SUFFIX"
    wget -O polkadot-execute-worker "https://github.com/paritytech/polkadot-sdk/releases/download/$POLKADOT_V/polkadot-execute-worker$SUFFIX"
    wget -O polkadot-prepare-worker "https://github.com/paritytech/polkadot-sdk/releases/download/$POLKADOT_V/polkadot-prepare-worker$SUFFIX"
    wget -O polkadot-parachain "https://github.com/paritytech/polkadot-sdk/releases/download/$POLKADOT_V/polkadot-parachain$SUFFIX"
    chmod +x ./*
  popd
}
...
zombienet_init() {
  if [ ! -f "$ZOMBIENET_BIN" ]; then
    ...
    wget -O "$ZOMBIENET_BIN" https://github.com/paritytech/zombienet/releases/download/$ZOMBIENET_V/"$ZOMBIENET_FILE-arm64"
